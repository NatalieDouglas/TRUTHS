...
class sensorGeometry:
  ...
  def printGeom(self):
    ...
    print(self.vza, self.vaa, self.sza, self.saa)


#def getSentinel2Geometry(startDateUTC,lengthDays,lat,lon,alt=0.0,mission="Sentinel-2a",tleFile="./TLE/norad_resource_tle.txt"):
def getSentinel2Geometry(startDateUTC,lengthDays,lat,lon,alt=0.0,mission="Sentinel-2a",tleFile="/home/users/ndouglas/TRUTHS/sentinelSimulator-master/TLE/norad_resource_tle.txt"):    
