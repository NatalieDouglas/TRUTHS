...
class fourDEnVar_engine_gamma:
    ...
    def fourDEnVar(self):
        ...
        #w_analytical=-np.dot(np.linalg.pinv(work1),work2)
        ...
        #wgrad1=np.dot(self.Yb_dash,w_analytical)-self.y
    ...
    def fourDEnVar_sample_posterior(self):
        ...
        Wa = np.linalg.pinv(work3) # temporary
    ...
    def callbackF(self, w):
        fobj = self.fourDEnVar_cost_f(w)
        self.historyJ.append(fobj)
        self.historyW.append(np.dot(w.T,w))
